...
Use this information and the techniques we learned today to build a dataset 
...
As final task for today, let's create a data set from the API for the popular
