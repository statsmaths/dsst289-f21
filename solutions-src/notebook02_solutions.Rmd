...
List three of the features in the data set. **Answer**: name, country, and
population are three examples.
...
Now, take the code above and reformat it to use a pipe in place of the temporary
variable.
